...
import IllustrationHttps from "@/assets/illustration_https.png";
import IllustrationFree from "@/assets/illustration_free.png";
import IllustrationDomain from "@/assets/illustration_domain.png";
import IllustrationBox from "@/assets/illustration-box.png";
        ...
        <div className="relative">
          <div className="relative z-10 grid grid-cols-6 gap-3">
            <Card className="relative col-span-full flex overflow-hidden lg:col-span-2">
              <CardContent className="relative m-auto size-fit pt-6 flex justify-center flex-col items-center">
              ...
              <CardContent className="pt-6">
                ...
                <div className="relative z-10 mt-6 space-y-2 text-center">
                  ...
                  <p className="text-foreground">
                    All templates come with free HTTPS—no extra setup needed.
                  </p>
                </div>
              </CardContent>
            </Card>
            <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
              <CardContent className="pt-6">
                ...
                <div className="relative z-10 mt-6 space-y-2 text-center">
                  ...
                  <p className="text-foreground">
                    Start for free. Most paid plans begin at just IDR
                    15,000/month.
                  </p>
                </div>
              </CardContent>
              ...
              <CardContent className="grid pt-6 sm:grid-cols-2">
                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                  <div className="space-y-2">
                    ...
                    <p className="text-foreground">
                      Explore and purchase from our extensive container library,
                      all verified and ready for instant deployment.
                    </p>
                  </div>
                </div>
              ...
              <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                  <div className="space-y-2">
                    ...
                    <p className="text-foreground">
                      Personalize your app with your own domain—feature
                      launching soon!
                    </p>
                  </div>
                </div>

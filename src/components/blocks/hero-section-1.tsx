...
import LogoSrc from "@/assets/logo_2.png";
  ...
  return (
    <>
      ...
      <main className="overflow-hidden">
        ...
        <section className="">
          <div className="relative h-screen pt-24 md:pt-36 pattern-grid">
            <AnimatedGroup
              variants={{
                container: {
                  visible: {
              ...
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                <AnimatedGroup variants={transitionVariants}>
                  ...
                  <p className="mx-auto mt-8 max-w-2xl text-balance text-lg text-muted-foreground">
                    Instant, affordable, and secure app deployment—no DevOps
                    required.
                  </p>
                </AnimatedGroup>
        ...
        <section className="bg-background pb-16 pt-16 md:pb-32">
          <div className="group relative m-auto max-w-5xl px-6">
            <p className="lg:text-6xl md:text-4xl text-3xl">
              ...
              Choose a template, deploy instantly, and scale easily—no DevOps or
...
const Logo = ({ className }: { className?: string }) => {
  return <img src={LogoSrc} className="w-[110px]" alt="logo" />;
};
